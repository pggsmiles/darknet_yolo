...
char *voc_names[] = {"bolt", "nut"};

void train_yolo(char *cfgfile, char *weightfile)
{
    char *train_images = "/home/cae/opencv/opencv-3.4.0/build/darknet/data/train.txt";
    char *backup_directory = "/home/cae/opencv/opencv-3.4.0/build/darknet/backup/";
    srand(time(0));
